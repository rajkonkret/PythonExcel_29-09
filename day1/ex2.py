...
print(wb)  # <openpyxl.workbook.workbook.Workbook object at 0x000001ED1B3C3230>
...
print('Value in cal A1 is:', ws['A1'].value)  # Value in cal A1 is: Rank

# list comprehensions
# wczytanie wszystkich kolumn z wiersza 1
# zapisanie do listy
# +1 - excel numeruje od 1, python od 0. potrzebny by wyswietlił ostatnia kolumne
